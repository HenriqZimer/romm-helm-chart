...
### Changed
- Bump default RomM version to `5.2.0` (`romm.image.tag` and `appVersion`), from `5.1.0`.

## [1.5.4] - 2026-08-17

### Fixed
- README install commands now use a unique repo alias (`romm-helm-chart`) instead of the bare chart name, and pin `--version` explicitly.
